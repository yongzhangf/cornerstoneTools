...
export default class ImageId {
  constructor (stackId, { dimension, index }, timePoint) {
  ...
  static fromURL (url) {
    // Reformatting:stackId(#(sliceDimension-)?sliceIndex?)?
    // - 'reformatting://' is constant and should begin the string
    // - '([^#]+)' is the stackId and it should not contain the '#' symbol
