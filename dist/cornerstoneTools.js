/*! cornerstone-tools - 2.3.8 - 2018-09-13 | (c) 2017 Chris Hafey | https://github.com/cornerstonejs/cornerstoneTools */
...
/******/ 	var hotCurrentHash = "bf5347ccf64d84f916a5"; // eslint-disable-line no-unused-vars
...
function endDrawing(eventData, handleNearby) {
  ...
  var drawEndingEventData = {
    element: eventData.element,
    toolType: toolType,
    measurementData: data
  };

  (0, _triggerEvent2.default)(eventData.element, _events2.default.DRAW_ENDING, drawEndingEventData);
...
exports.default = function (mouseToolInterface) {
  ...
  function mouseDownCallback(e) {
    ...
    function handleDoneMove() {
      ...
      (0, _triggerEvent2.default)(element, _events2.default.DRAW_ENDING, drawEndingEventData);
